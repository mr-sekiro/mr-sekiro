...
- 🏗️ Skilled in **design patterns** (Repository, Unit of Work, DI, Factory, Singleton, Observer) for scalable and maintainable systems.  
- ☁️ Exploring **cloud technologies (AWS, Docker)** and **modern backend architectures** like **microservices**.  
